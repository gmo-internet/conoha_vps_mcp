 ...
 *
 * @remarks
 * サーバーIDをキーとしたメトリクスのマップ。
 *
 * @packageDocumentation
 */

import type { AppServerMetrics } from "../apps-types.js";

export const metrics: Record<string, AppServerMetrics> = {
